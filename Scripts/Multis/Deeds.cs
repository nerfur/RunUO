...
namespace Server.Multis.Deeds
{
	...
	public class StonePlasterHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a stone and plaster house"));
            }
        }
	...
	public class FieldStoneHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a field stone house"));
            }
        }
	...
	public class SmallBrickHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a small brick house"));
            }
        }
	...
	public class WoodHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a wooden house"));
            }
        }
	...
	public class WoodPlasterHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a wood and plaster house"));
            }
        }
	...
	public class ThatchedRoofCottageDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a thatched roof cottage"));
            }
        }
	...
	public class BrickHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a brick house"));
            }
        }
	...
	public class TwoStoryWoodPlasterHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a two story wood and plaster house"));
            }
        }
	...
	public class TwoStoryStonePlasterHouseDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a two story stone and plaster house"));
            }
        }
	...
	public class TowerDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a deed to a tower"));
            }
        }
	...
	public class KeepDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a small stone keep deed"));
            }
        }
	...
	public class CastleDeed : HouseDeed
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a castle deed"));
            }
        }
