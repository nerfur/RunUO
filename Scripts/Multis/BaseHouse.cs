...
namespace Server.Multis
{
	public abstract class BaseHouse : BaseMulti
	{
		...
		public virtual TimeSpan DecayPeriod{ get{ return TimeSpan.FromDays( 24.0 ); } }
		...
		public static BaseHouse FindHouseAt( Point3D loc, Map map, int height )
		{
			...
			for ( int i = 0; i < sector.Multis.Count; ++i )
			{
                ...
                if (house != null && (loc.Z >= 66 - 5) && house.Z <= 66 - 5)
                    continue;
		...
		public override void OnMapChange()
		{
            ...
            if (m_Chest != null)
                m_Chest.Map = this.Map;

            if (m_SmallForge != null)
                m_SmallForge.Map = this.Map;

            if (m_LargeForge != null)
                m_LargeForge.Map = this.Map;

            if (m_Anvil != null)
                m_Anvil.Map = this.Map;

            if (m_Loom != null)
                m_Loom.Map = this.Map;

            if (m_SpinningWheel1 != null)
                m_SpinningWheel1.Map = this.Map;

            if (m_SpinningWheel2 != null)
                m_SpinningWheel2.Map = this.Map;

            if (m_Oven != null)
                m_Oven.Map = this.Map;

            if (m_Fireplace != null)
                m_Fireplace.Map = this.Map;

            if (m_Mill != null)
                m_Mill.Map = this.Map;

            if (m_Training1 != null)
                m_Training1.Map = this.Map;

            if (m_Training2 != null)
                m_Training2.Map = this.Map;

            if (m_Pick1 != null)
                m_Pick1.Map = this.Map;

            if (m_Pick2 != null)
                m_Pick2.Map = this.Map;
		...
		public override void OnLocationChange( Point3D oldLocation )
		{
            ...
            if (m_Chest != null)
                m_Chest.Location = new Point3D(m_Chest.X + x, m_Chest.Y + y, m_Chest.Z + z);

            if (m_SmallForge != null)
                m_SmallForge.Location = new Point3D(m_SmallForge.X + x, m_SmallForge.Y + y, m_SmallForge.Z + z);

            if (m_LargeForge != null)
                m_LargeForge.Location = new Point3D(m_LargeForge.X + x, m_LargeForge.Y + y, m_LargeForge.Z + z);

            if (m_Anvil != null)
                m_Anvil.Location = new Point3D(m_Anvil.X + x, m_Anvil.Y + y, m_Anvil.Z + z);

            if (m_Loom != null)
                m_Loom.Location = new Point3D(m_Loom.X + x, m_Loom.Y + y, m_Loom.Z + z);

            if (m_SpinningWheel1 != null)
                m_SpinningWheel1.Location = new Point3D(m_SpinningWheel1.X + x, m_SpinningWheel1.Y + y, m_SpinningWheel1.Z + z);

            if (m_SpinningWheel2 != null)
                m_SpinningWheel2.Location = new Point3D(m_SpinningWheel2.X + x, m_SpinningWheel2.Y + y, m_SpinningWheel2.Z + z);

            if (m_Oven != null)
                m_Oven.Location = new Point3D(m_Oven.X + x, m_Oven.Y + y, m_Oven.Z + z);

            if (m_Fireplace != null)
                m_Fireplace.Location = new Point3D(m_Fireplace.X + x, m_Fireplace.Y + y, m_Fireplace.Z + z);

            if (m_Mill != null)
                m_Mill.Location = new Point3D(m_Mill.X + x, m_Mill.Y + y, m_Mill.Z + z);

            if (m_Training1 != null)
                m_Training1.Location = new Point3D(m_Training1.X + x, m_Training1.Y + y, m_Training1.Z + z);

            if (m_Training2 != null)
                m_Training2.Location = new Point3D(m_Training2.X + x, m_Training2.Y + y, m_Training2.Z + z);

            if (m_Pick1 != null)
                m_Pick1.Location = new Point3D(m_Pick1.X + x, m_Pick1.Y + y, m_Pick1.Z + z);

            if (m_Pick2 != null)
                m_Pick2.Location = new Point3D(m_Pick2.X + x, m_Pick2.Y + y, m_Pick2.Z + z);
        ...
        public BaseDoor AddEastDoorShop(int x, int y, int z)
        {
            BaseDoor door = MakeDoor(true, DoorFacing.NorthCW);
        ...
        public BaseDoor AddEastDoorShop(int x, int y, int z, uint k)
        {
            BaseDoor door = MakeDoor(true, DoorFacing.NorthCW);
        ...
        public BaseDoor AddSouthDoorShop(int x, int y, int z)
        {
            BaseDoor door = MakeDoor(true, DoorFacing.EastCCW);
		...
		{
            m_Sign = new HouseSign( this, m_KeyOwner );
		...
		public override void OnAfterDelete()
		{
            ...
            if (m_SpinningWheel1 != null)
                m_SpinningWheel1.Delete();

            if (m_SpinningWheel2 != null)
                m_SpinningWheel2.Delete();
		...
		public void RemoveKeys( Mobile m )
		{
            ...
            if (m_Chest != null)
            {
                uint keyValue = m_Chest.KeyValue;
                Key.RemoveKeys(m, keyValue);
            }
		}
