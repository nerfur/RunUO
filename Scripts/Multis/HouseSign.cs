	...
	public class HouseSign : Item
	{
		...
		public override void OnSingleClick( Mobile from )
		{
            if (m_Owner != null && BaseHouse.DecayEnabled && m_Owner.DecayPeriod != TimeSpan.Zero)
            {
                ...
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", GetName()));
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", String.Format("This house is {0}.", message)));
            }
