...
namespace Server.Misc
{
	public class SkillCheck
	{
		...
		public static bool Mobile_SkillCheckLocation( Mobile from, SkillName skillName, double minSkill, double maxSkill )
		{
            ...
            from.Skills[skillName].LastUsed = DateTime.Now;
		...
		public static bool Mobile_SkillCheckDirectLocation( Mobile from, SkillName skillName, double chance )
		{
            ...
            if (skillName == SkillName.Meditation)
                return false;
		...
		public static bool CheckSkill( Mobile from, Skill skill, object amObj, double chance )
		{
            ...
            from.Skills[skill.SkillName].LastUsed = DateTime.Now;
			return success;
		}
		...
		{
			atrophy = /*atrophy ||*/ (from.RawStatTotal >= from.StatCap && CanRaise(from, stat));
        ...
        private static TimeSpan m_StatGainDelay = TimeSpan.Zero;//TimeSpan.FromMinutes( 15.0 );
