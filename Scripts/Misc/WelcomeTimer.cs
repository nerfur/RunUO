...
namespace Server.Misc
{
	...
	public class WelcomeTimer : Timer
	{
		...
		private static string[] m_Messages = ( TestCenter.Enabled ?
			new string[]
				{
					"Welcome to UO: Origins Beta Phase.  You are able to customize your character's stats and skills at anytime to anything you wish.  To see the commands to do this just say 'help'."
		...
		{
			if ( m_State < m_Count )
				m_Mobile.SendAsciiMessage( 0x35, m_Messages[m_State++] );
