...
namespace Server.Misc
{
	...
	{
		private static TimeSpan m_Delay = TimeSpan.FromHours( 1.0 );
		...
		protected override void OnTick()
		{
			...
			else
			{
				...
				if ( m > 0 && s > 0 )
                    ...
                    World.Broadcast(0x35, true, "[System]: The server is about to save. You may experience some lag for the next several seconds.");
