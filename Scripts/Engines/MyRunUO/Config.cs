...
namespace Server.Engines.MyRunUO
{
	public class Config
	{
        ...
        //public static string DatabaseDriver         = "{MySQL ODBC 5.1 Driver}";
		public static string DatabaseServer			= "74.200.236.250";
		public static string DatabaseName			= "uoorigin_my";
		public static string DatabaseUserID			= "uoorigin_admin";
		public static string DatabasePassword		= "zxvf8c3u";
