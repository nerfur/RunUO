...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
        ...
        public override int PlayEndingEffect(Mobile from, bool failed, bool lostMaterial, bool toolBroken, int quality, bool makersMark, CraftItem item)
        {
            ...
            if (failed)
            {
                if (item is DartTrapCraft || item is ExplosionTrapCraft || item is PoisonTrapCraft)
                    from.SendAsciiMessage("You fail to set the trap properly.");
                else
		...
		public override void InitCraftList()
		{
			...
			#region Wooden Items
            AddCraft(typeof(Axle), 1044042, 1024187, 0, 100.0, typeof(Log), 1044041, 2, 1044351);
            AddCraft(typeof(MouldingPlane), 1044042, 1024140, 0.0, 100.0, typeof(Log), 1044041, 4, 1044351);
            AddCraft(typeof(SmoothingPlane), 1044042, 1024146, 0.0, 100.0, typeof(Log), 1044041, 4, 1044351);
            AddCraft(typeof(JointingPlane), 1044042, 1024144, 0.0, 100.0, typeof(Log), 1044041, 4, 1044351);
            AddCraft(typeof(ClockFrame), 1044042, 1024173, 0.0, 100.0, typeof(Log), 1044041, 6, 1044351);
            ...
            // Dart Trap
            index = AddCraft(typeof(DartTrapCraft), 1044052, 1024396, 0, 100.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddRes(index, typeof(Bolt), 1044570, 1, 1044253);

            // Explosion Trap
            index = AddCraft(typeof(ExplosionTrapCraft), 1044052, 1044597, 0, 100.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddRes(index, typeof(BaseExplosionPotion), 1044569, 1, 1044253);

            // Poison Trap
            index = AddCraft(typeof(PoisonTrapCraft), 1044052, 1044593, 0, 100.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddRes(index, typeof(BasePoisonPotion), 1044571, 1, 1044253);

			#region Tools
            AddCraft(typeof(SewingKit), 1044046, 1023997, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Gears), 1044047, 1024179, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Springs), 1044047, 1024189, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Hinge), 1044047, 1024181, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(DrawKnife), 1044046, 1024324, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Froe), 1044046, 1024325, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Inshave), 1044046, 1024326, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Scorp), 1044046, 1024327, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(ButcherKnife), 1044046, 1024327, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Scissors), 1044046, 1023998, 0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Tongs), 1044046, 1024028, 0, 100.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddCraft(typeof(DovetailSaw), 1044046, 1024136, 0, 100.0, typeof(IronIngot), 1044036, 4, 1044037);
            AddCraft(typeof(Saw), 1044046, 1024148, 0, 100.0, typeof(IronIngot), 1044036, 4, 1044037);
            AddCraft(typeof(Hammer), 1044046, 1024138, 0, 100.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddCraft(typeof(SmithHammer), 1044046, 1025091, 0, 100.0, typeof(IronIngot), 1044036, 4, 1044037);
            AddCraft(typeof(SledgeHammer), 1044046, 1024021, 0, 100.0, typeof(IronIngot), 1044036, 4, 1044037);
            AddCraft(typeof(Shovel), 1044046, 1023898, 0, 100.0, typeof(IronIngot), 1044036, 4, 1044037);
	...
	public abstract class TrapCraft : CustomCraft
	{
        ...
        public override Item CompleteCraft(out int message)
        {
            ...
            if (message == 0)
            {
                ...
                Container.TrapOnLockpick = false;

                From.SendAsciiMessage("You successfully set the trap.");
