...
namespace Server.Engines.Craft
{
	public class DefBowFletching : CraftSystem
	{
		...
		private DefBowFletching() : base( 2, 3, 2.5 )// base( 1, 2, 1.7 )
		{
		}
		...
		public override CraftECA ECA{ get{ return /*CraftECA.FiftyPercentChanceMinusTenPercent*/CraftECA.ChanceMinusSixty; } }
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( Shaft ), 1044457, 1027124, 0.0, 50.0, typeof( Log ), 1044041, 1, 1044351 );
            ...
            index = AddCraft(typeof(Crossbow), 1044566, 1023919, 40.0, 100.0, typeof(Log), 1044041, 7, 1044351);
            //ForceNonExceptional(index);

            index = AddCraft(typeof(HeavyCrossbow), 1044566, 1025117, 50.0, 120.0, typeof(Log), 1044041, 10, 1044351);
            //ForceNonExceptional(index);
