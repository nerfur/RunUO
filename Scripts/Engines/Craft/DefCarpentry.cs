...
namespace Server.Engines.Craft
{
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            AddCraft( typeof( FootStool ),					1044291, 1022910,	0.0,  100.0,	typeof( Log ), 1044041,  9, 1044351 );
            AddCraft( typeof( Stool ),						1044291, 1022602,	0.0,  100.0,	typeof( Log ), 1044041,  9, 1044351 );
            AddCraft( typeof( BambooChair ),				1044291, 1044300,	0.0,  100.0,	typeof( Log ), 1044041, 13, 1044351 );
            AddCraft( typeof( WoodenChair ),				1044291, 1044301,	0.0,  100.0,	typeof( Log ), 1044041, 13, 1044351 );
            AddCraft( typeof( FancyWoodenChairCushion ),	1044291, 1044302,	0.0,  100.0,	typeof( Log ), 1044041, 15, 1044351 );
            AddCraft( typeof( WoodenChairCushion ),			1044291, 1044303,	0.0,  100.0,	typeof( Log ), 1044041, 13, 1044351 );
            AddCraft( typeof( WoodenBench ),				1044291, 1022860,	0.0,  100.0,	typeof( Log ), 1044041, 17, 1044351 );
            AddCraft( typeof( WoodenThrone ),				1044291, 1044304,	0.0,  100.0,	typeof( Log ), 1044041, 17, 1044351 );
            AddCraft( typeof( Throne ),						1044291, 1044305,	0.0,  100.0,	typeof( Log ), 1044041, 19, 1044351 );
            AddCraft( typeof( Nightstand ),					1044291, 1044306,	0.0,  100.0,	typeof( Log ), 1044041, 17, 1044351 );
            AddCraft( typeof( WritingTable ),				1044291, 1022890,	0.0,  100.0,	typeof( Log ), 1044041, 17, 1044351 );
            AddCraft( typeof( YewWoodTable ),				1044291, 1044307,	0.0,  100.0,	typeof( Log ), 1044041, 23, 1044351 );
            AddCraft( typeof( LargeTable ),					1044291, 1044308,	0.0, 100.0,	typeof( Log ), 1044041, 27, 1044351 );
            ...
            AddCraft(typeof(WoodenShield), 1044295, 1027034, 0.0, 100.0, typeof(Log), 1044041, 9, 1044351);
            AddCraft(typeof(WoodenBox), 1044292, 1023709, 0.0, 100.0, typeof(Log), 1044041, 10, 1044351);
            AddCraft(typeof(SmallCrate), 1044292, 1044309, 0.0, 100.0, typeof(Log), 1044041, 8, 1044351);
            AddCraft(typeof(MediumCrate), 1044292, 1044310, 0.0, 100.0, typeof(Log), 1044041, 15, 1044351);
            AddCraft(typeof(LargeCrate), 1044292, 1044311, 0.0, 100.0, typeof(Log), 1044041, 18, 1044351);
            AddCraft(typeof(WoodenChest), 1044292, 1023650, 0.0, 100.0, typeof(Log), 1044041, 20, 1044351);
            AddCraft(typeof(EmptyBookcase), 1044292, 1022718, 0.0, 100.0, typeof(Log), 1044041, 25, 1044351);
            AddCraft(typeof(FancyArmoire), 1044292, 1044312, 0.0, 100.0, typeof(Log), 1044041, 35, 1044351);
            AddCraft(typeof(Armoire), 1044292, 1022643, 0.0, 100.0, typeof(Log), 1044041, 35, 1044351);	
			...
			// Staves and Shields
			AddCraft( typeof( ShepherdsCrook ), 1044295, 1023713, 0.0, 100.0, typeof( Log ), 1044041, 7, 1044351 );
            AddCraft(typeof(QuarterStaff), 1044295, 1023721, 0.0, 100.0, typeof(Log), 1044041, 6, 1044351);
            AddCraft(typeof(GnarledStaff), 1044295, 1025112, 0.0, 100.0, typeof(Log), 1044041, 7, 1044351);
            //AddCraft(typeof(WoodenShield), 1044295, 1027034, 0.0, 100.0, typeof(Log), 1044041, 9, 1044351);

			if( !Core.AOS )	//Duplicate Entries to preserve ordering depending on era 
			{
				index = AddCraft( typeof( FishingPole ), 1044295, 1023519, 0.0, 100.0, typeof( Log ), 1044041, 5, 1044351 ); //This is in the categor of Other during AoS
				AddSkill( index, SkillName.Tailoring, 0.0, 100.0 );
				AddRes( index, typeof( Cloth ), 1044286, 5, 1044287 );
			}
