...
namespace Server.Engines.Craft
{
	public class DefBlacksmithy : CraftSystem
	{
		...
		private DefBlacksmithy() : base( 3, 5, 1.8 )// base( 1, 2, 1.7 )
		{
			/*
		...
		public override int PlayEndingEffect( Mobile from, bool failed, bool lostMaterial, bool toolBroken, int quality, bool makersMark, CraftItem item )
		{
			...
			else
			{
                ...
                if (quality == 0)
                    from.SendAsciiMessage("You were barely able to make this item. Its quality is below average.");
                /*else if (makersMark && quality == 2)
                    from.SendAsciiMessage("You create an exceptional quality item and affix your maker's mark.");*/
                else if (quality == 2)
                    from.SendAsciiMessage("Due to your exceptional skill, this item's quality is higher than average.");
			}
