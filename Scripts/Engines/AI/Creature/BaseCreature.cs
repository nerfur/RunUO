...
namespace Server.Mobiles
{
	...
	public class BaseCreature : Mobile, IHonorTarget
	{
        ...
        private SophisticationLevel m_Sophistication;
        [CommandProperty(AccessLevel.GameMaster)]
        public SophisticationLevel Sophistication
        {
            get { return m_Sophistication; }
            set { m_Sophistication = value; }
        }

        private AttitudeLevel m_Attitude;
        [CommandProperty(AccessLevel.GameMaster)]
        ...
        #region Items
        public Item PlainShirt(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 2))
            {
                case 0:
                    return new FancyShirt(hue);
                case 1:
                    return new Doublet(hue);
                default:
                case 2:
                    return new Shirt(hue);
            }
        }

        public Item PlainPants(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 1))
            {
                case 0:
                    return new ShortPants(hue);
                default:
                case 1:
                    return new LongPants(hue);
            }
        }

        public Item Skirt(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 1))
            {
                case 0:
                    return new Skirt(hue);
                default:
                case 1:
                    return new Kilt(hue);
            }
        ...
        public Item RandomOverArmor(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 2))
            {
                case 0:
        ...
        public Item RandomBoots(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 1))
            {
                case 0:
        ...
        public Item RandomShoes(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 1))
            {
                case 0:
        ...
        public Item RandomFootware(int hue = 0)
        {
        ...
        public Item RandomChestArmor(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 4))
            {
                default:
                case 0:
                    return new StuddedChest();
                case 1:
                    return new PlateChest();
                case 2:
                    return new ChainChest();
                case 3:
                    return new LeatherChest();
                case 4:
                    return new RingmailChest();
            }
        }

        public Item RandomLegArmor(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 4))
            {
                default:
                case 0:
                    return new StuddedLegs();
                case 1:
                    return new PlateLegs();
                case 2:
                    return new ChainLegs();
                case 3:
                    return new LeatherLegs();
                case 4:
                    return new RingmailLegs();
            }
        }

        public Item RandomArmArmor(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 3))
            {
                default:
                case 0:
                    return new StuddedArms();
                case 1:
                    return new PlateArms();
                case 2:
                    return new RingmailArms();
                case 3:
                    return new LeatherArms();
            }
        }

        public Item RandomGloves(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 2))
            {
                default:
                case 0:
                    return new StuddedGloves();
                case 1:
                    return new PlateGloves();
                case 2:
                    return new LeatherArms();
            }
        }

        public Item RandomHeadArmor(int hue = 0)
        {
            switch (Utility.RandomMinMax(0, 5))
            {
                default:
                case 0:
                    return new ChainCoif();
                case 1:
                    return new CloseHelm() { ItemID = 5129 };
                case 2:
                    return new Helmet() { ItemID = 5131 };
                case 3:
                    return new Bascinet() { ItemID = 5133 };
                case 4:
                    return new NorseHelm() { ItemID = 5135 };
                case 5:
                    return new PlateHelm();
            }
        }

        public Item RandomHelmet()
        {
            switch (Utility.RandomMinMax(0, 4))
            {
                default:
        ...
        public Item RandomShield()
        {
            switch (Utility.RandomMinMax(0, 9))
            {
                ...
                case 1:
                    return new Buckler();
                case 2:
                    return new MetalKiteShield();
                case 3:
                    return new MetalKiteShield() { ItemID = 7029 };
                case 4:
                    return new HeaterShield();
                case 5:
                    return new HeaterShield() { ItemID = 7031 };
                case 6:
                    return new WoodenKiteShield();
                case 7:
                    return new WoodenKiteShield() { ItemID = 7033 };
                case 8:
        ...
        public Item RandomGorget()
        {
            switch (Utility.RandomMinMax(0, 3))
            {
                default:
                case 0:
                    return new StuddedGorget();
                case 1:
                    return new LeatherGorget();
                case 2:
                    return new PlateGorget();
                case 3:
                    return new StuddedGorget();
            }
        }
        ...
        public bool CheckHome()
        {
            ...
            if (GetDistanceToSqrt(Home) > (double)(RangeHome + 10) && !Controlled && LastOwner == null)
            {
                this.Location = Home;
                return true;
            }
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                if (Summoned)
                    PrivateOverheadMessage(MessageType.Regular, 0x3B2, true, "(summoned)", from.NetState);
                else
                {
                    if (!(this is BaseHire))
                        PrivateOverheadMessage(MessageType.Regular, 0x3B2, true, "(tame)", from.NetState);
                }
            }
		...
		public virtual bool CanMoveOverObstacles
		{
			get
			{
                return true;//Core.AOS || this.Body.IsMonster;
			}
		}
		...
		public virtual void OnCarve( Mobile from, Corpse corpse )
		{
			...
			if ( (feathers == 0 && wool == 0 && meat == 0 && hides == 0 && scales == 0 && fur == 0) || Summoned || IsBonded )
			{
				from.SendAsciiMessage( "You see nothing useful to carve from the corpse." ); // You see nothing useful to carve from the corpse.
			}
			else
			{
				...
				if ( feathers != 0 )
				{
					...
					from.SendAsciiMessage( "You pluck the bird. The feathers are now on the corpse." ); // You pluck the bird. The feathers are now on the corpse.
				}

				if ( wool != 0 )
				{
					corpse.DropItem( new Wool( wool ) );
					from.SendAsciiMessage( "You shear it, and the wool is now on the corpse." ); // You shear it, and the wool is now on the corpse.
				}
                ...
                if (fur != 0)
                {
                    ...
                    {
                        case 0: corpse.DropItem(new Fur1(fur)); break;
                        case 1: corpse.DropItem(new Fur2(fur)); break;
                        case 2: corpse.DropItem(new Fur3(fur)); break;
                        case 3: corpse.DropItem(new Fur4(fur)); break;
                    }
                    from.SendAsciiMessage("You skin the corpse and get the fur. It is now in the corpse.");
                }
				...
				if ( meat != 0 )
				{
					...
					from.SendAsciiMessage( "You carve some meat, which remains on the corpse." ); // You carve some meat, which remains on the corpse.
				}
				...
				if ( hides != 0 )
				{
					...
					from.SendAsciiMessage( "You skin it, and the hides are now in the corpse." ); // You skin it, and the hides are now in the corpse.
				}
			...
			double dPassiveSpeed)
		{
            ...
            LastTimeInHomeRange = DateTime.Now;
            ...
            m_Sophistication = SophisticationLevel.Medium;
            m_Attitude = (AttitudeLevel)Utility.RandomMinMax(0,2);
            ...
            m_SwingTimer = new SwingCounterTimer(this);
            m_SwingTimer.Start();
		}
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write((DateTime)ReleaseTime);
            writer.Write((DateTime)LastTimeInHomeRange);
            ...
            writer.Write((int)m_Sophistication);
		...
		public override void Deserialize( GenericReader reader )
		{
            ...
            if (version >= 19)
                ReleaseTime = reader.ReadDateTime();
            else
                ReleaseTime = DateTime.MinValue;

            if (version >= 18)
                LastTimeInHomeRange = reader.ReadDateTime();
            ...
            if (version >= 17)
            {
                m_Sophistication = (SophisticationLevel)reader.ReadInt();
                m_Attitude = (AttitudeLevel)reader.ReadInt();
            }
		...
		public virtual bool OnGoldGiven( Mobile from, Gold dropped )
		{
			...
			else if ( IsHumanInTown() )
			{
				...
				SayTo( from, true, "Thou art giving me gold?" );

				if ( dropped.Amount >= 400 )
					SayTo( from, true, "'Tis a noble gift." );
				else
					SayTo( from, true, "Money is always welcome." );

				this.SpeechHue = 0x3B2;
				SayTo( from, true,  "I thank thee."); // I thank thee.
			...
			if ( !IsDeadPet && Controlled && (ControlMaster == from || IsPetFriend( from )) && (dropped is Food || dropped is Gold || dropped is CookableFood || dropped is Head || dropped is LeftArm || dropped is LeftLeg || dropped is Torso || dropped is RightArm || dropped is RightLeg) )
			{
				...
				if ( CheckFoodPreference( f ) )
				{
					...
					if ( amount > 0 )
					{
						...
						if ( happier )
                            SayTo(from, true, "Your pet looks happier."); // Your pet looks happier.
		...
		public virtual TeachResult CheckTeachSkills( SkillName skill, Mobile m, int maxPointsToLearn, ref int pointsToLearn, bool doTeach )
		{
			...
			if ( doTeach )
			{
                ...
                while (need > 0)
                {
                    ...
                    {
                        Skill toLower = m.Skills[i];

                        if (toLower != theirSkill && toLower.BaseFixedPoint > 0)
                        {
                            if (toLower.LastUsed <= value)
                            {
                                lowest = toLower;
                                value = toLower.LastUsed;
                            }
                        }
                    }
                    ...
                    if (lowest != null)
                    {
                        if (lowest.BaseFixedPoint < need)
                        {
                            need -= lowest.BaseFixedPoint;
                            lowest.BaseFixedPoint = 0;
                        }
                        else
                        {
                            lowest.BaseFixedPoint -= need;
                            need = 0;
                        }
                    }
                }
				...
				/*for ( int i = 0; need > 0 && i < m.Skills.Length; ++i )
				{
					...
					if ((sk == theirSkill || sk.BaseFixedPoint == 0) && sk.LastUsed > value )
						continue;
		...
		public virtual bool Teach( SkillName skill, Mobile m, int maxPointsToLearn, bool doTeach )
		{
			...
			switch ( res )
			{
				...
				{
					Say( true, "I cannot teach thee, for thou knowest more than I!" ); // I cannot teach thee, for thou knowest more than I!
					break;
				}
				case TeachResult.KnowsWhatIKnow:
				{
                    Say(true, "I cannot teach thee, for thou knowest all I can teach!"); // I cannot teach thee, for thou knowest all I can teach!
					break;
				}
				...
				case TeachResult.Success:
				{
					if ( doTeach )
					{
						Say( true, "Let me show thee something of how this is done." ); // Let me show thee something of how this is done.
						m.SendAsciiMessage( "Your skill level increases." ); // Your skill level increases.
					...
					else
					{
						...
						Say( true, String.Format("I will teach thee all I know, if paid the amount in full.  The price is: {0}", pointsToLearn ));
						Say( true, "For less I shall teach thee less." ); // For less I shall teach thee less.
		...
		public override bool IsHarmfulCriminal( Mobile target )
		{
            ...
            //if (((target.Karma < -39) && (target.Karma > -127)) && target is PlayerMobile && Controlled && target.Criminal == false)
            //    return true;
		...
		{
            if (GetDistanceToSqrt(Home) <= (RangeHome + 10))
                LastTimeInHomeRange = DateTime.Now;
            ...
            if (Home != new Point3D(0, 0, 0))
            {
                if (this is BaseVendor)
                {
                    if (DateTime.Now - LastTimeInHomeRange > TimeSpan.FromHours(1.0))
                        Location = Home;
                }
                else if (!Controlled && LastOwner == null)
                {
                    if (DateTime.Now - LastTimeInHomeRange > TimeSpan.FromDays(1.0))
                        Location = Home;
                }
            }
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			if ( guardedRegion != null )
			{
				if ( !guardedRegion.IsDisabled() && guardedRegion.IsGuardCandidate( m ) && BeginAction( typeof( GuardedRegion ) ) )
				{
                    ...
                    {
                        case 0: Say(true, "Thou'rt scum! Guards!"); break;
                        case 1: Say(true, "Guards! A villain!"); break;
                        case 2: Say(true, "Tis a villain! Guards!"); break;
                        case 3: Say(true, "Guards! help!"); break;
                        case 4: Say(true, "Help! Guards! Flood, fire, famine!"); break;
                        case 5: Say(true, "Aaaah! They will kill me! Guards!"); break;
                        case 6: Say(true, "Arrest this scum!"); break;
                        case 7: Say(true, "Look! Tis that evil one! Guards!"); break;
                        case 8: Say(true, "Beware! 'Tis that scoundrel! Guards!"); break;
                        case 9: Say(true, "Look thee, a criminal! Guards!"); break;
                        case 10: Say(true, "Thy like is not welcome here! Guards! arrest this person!"); break;
                        case 11: Say(true, "Scum like thee is not welcome here. Guards!"); break;
                        case 12: Say(true, "To think I saw thee and lived! Guards!"); break;
                        case 13: Say(true, "We tolerate not those like thee! Guards!"); break;
                        case 14: Say(true, "Get out of here, scum! Guards!"); break;
                        case 15: Say(true, "Guards! Guards!"); break;
                    }
 ...
 /*       public virtual void AddLootBackpack(LootPack pack)
        ...
        public class BSTimer : Timer
		{
            BaseCreature m_BS;
			public BSTimer( BaseCreature bs ) : base( TimeSpan.FromSeconds(1.0), TimeSpan.FromSeconds(2.0) )
			{
                m_BS = bs;
			}
			...
			protected override void OnTick()
			{
                ...
                Effects.PlaySound(m_BS.Location, m_BS.Map, 0x23A);

                if (TimeSpan.Compare(Interval, TimeSpan.FromSeconds(2.0)) == 0)
                    this.Interval = TimeSpan.FromSeconds(1.0);
                else
                    this.Interval = TimeSpan.FromSeconds(2.0);
			}
		}
		...
		public virtual bool CanBreath { get { return HasBreath && !Summoned && !Frozen; } }
		...
		public virtual bool Rummage()
		{
			...
			for ( int i = 0; i < items.Count; ++i )
			{
				...
				if ( !rejected && Drop( this, new Point3D( -1, -1, 0 ) ) )
				{
                    ...
                    PublicOverheadMessage(MessageType.Emote, 0x3B2, true, "*rummages through a corpse and takes an item*");
					return true;
				}
			}
		...
		public void Provoke( Mobile master, Mobile target, bool bSuccess )
		{
			...
			this.PublicOverheadMessage( MessageType.Emote, EmoteHue, true, "*looks furious*" );
	...
	public class LoyaltyTimer : Timer
	{
		...
		protected override void OnTick() 
		{
				...
				if ( m is BaseCreature )
				{
					...
					else if ( c.Controlled && c.Commandable )
					{
						...
						if ( c.Map != Map.Internal )
						{
							...
							{
								c.Say( true, String.Format("* {0} looks around desperately *", c.Name )); // * ~1_NAME~ looks around desperately *
			...
			{
                c.ReleaseTime = DateTime.Now;
				c.Say( true, String.Format("{0} appears to have decided that is better off without a master!", c.Name )); // ~1_NAME~ appears to have decided that is better off without a master!
