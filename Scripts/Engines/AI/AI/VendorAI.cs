	...
	public class VendorAI : BaseAI
	{
		...
		public override bool DoActionWander()
		{
			...
			if ( m_Mobile.Combatant != null )
			{
                ...
                {
                    case 0: m_Mobile.Say(true, "Guards! A villan attacks me!"); break;
                    case 1: m_Mobile.Say(true, "Guards! Help!"); break;
                }
				//m_Mobile.Say( true, Utility.RandomList( "Guards! A villan attacks me!", "Guards! Help!" ) );
