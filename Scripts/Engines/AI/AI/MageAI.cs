...
namespace Server.Mobiles
{
	public class MageAI : BaseAI
	{
		...
		private Spell CheckCastHealingSpell()
		{
			...
			if ( m_Mobile.Poisoned && Utility.Random(100) < 10 )
		...
		public virtual Spell GetRandomDamageSpell()
		{
			...
			switch ( Utility.Random( maxCircle*2 ) )
			{
				...
				case  8: return new ParalyzeSpell( m_Mobile, null );
                case 9: case 10: return new EnergyBoltSpell(m_Mobile, null);
                case 11: case 12: return new ExplosionSpell(m_Mobile, null);
		...
		public override bool DoActionCombat()
		{
			...
			if ( m_Mobile.Spell == null && DateTime.Now > m_NextCastTime && m_Mobile.InRange( c, 12 ) )
			{
				...
				/*if ( m_Mobile.Poisoned && Utility.Random(100) < 10) // Top cast priority is cure
				{
