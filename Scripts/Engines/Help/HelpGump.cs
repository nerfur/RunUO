...
namespace Server.Engines.Help
{
    ...
    public class HelpMenu : QuestionMenu
    {
        ...
        public class HelpPrompt : Prompt
        {
            private Mobile m_From;
            private PageType m_Type;

            public HelpPrompt(Mobile from, PageType type)
            {
                m_From = from;
                m_Type = type;
            }
            ...
            {
                m_From.SendAsciiMessage(0x35, "Help request aborted."); // Help request aborted.
            }
        ...
        public HelpMenu(Mobile from) : base("Please remember, Game Masters are only available to help with the following types of calls: character cannot move, you are being harassed, or your character cannot continue. Please choose the area in which you require assistance from below.", new string[] { "GENERAL QUESTION ABOUT ULTIMA ONLINE: Select this option if you have a general gameplay question, need help learning to use a skill, or if you would like to search the UO Knowledge Base.",
                                                                                                                                                                                                                                                                                      "CHARACTER IS PHYSICALLY STUCK: This choice only overs cases where your character is physically stuck in a location they cannot move out of. This option will only work two times in 24 hours.",
                                                                                                                                                                                                                                                                                      "ANOTHER PLAYER IS HARASSING ME: Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please visit: http://support.uo.com/gm_9.html",
                                                                                                                                                                                                                                                                                      "OTHER: If you are experiencing a problem in the game that does not fall into one of the other categories or is not address on the Support web page, please use this option."
            })
        {
            m_From = from;
        }
