...
namespace Server.Engines.Help
{
		...
		private class InternalTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				if ( m_Entry.Sender.NetState != null && index != -1 )
				{
                    ...
                    m_Entry.Sender.SendAsciiMessage(String.Format("Thank you for paging. Queue status : {0}",(index + 1).ToString())); // Thank you for paging. Queue status : 
					m_Entry.Sender.SendAsciiMessage( "You can reference our website at www.uo.com or contact us at support@uo.com. To cancel your page, please select the help button again and select cancel." ); // You can reference our website at www.uo.com or contact us at support@uo.com. To cancel your page, please select the help button again and select cancel.
				}
				else
				{
					if ( index != -1 )
	...
	public class PageQueue
	{
		...
		public static bool CheckAllowedToPage( Mobile from )
		{
			...
			{
				from.SendAsciiMessage( "You cannot request help, sorry." );
				return false;
			}
		...
		public static void Enqueue( PageEntry entry )
		{
			...
			if ( !isStaffOnline )
				entry.Sender.SendAsciiMessage( "We are sorry, but no staff members are currently available to assist you.  Your page will remain in the queue until one becomes available, or until you cancel it manually." );
