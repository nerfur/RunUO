...
namespace Server.Engines.Harvest
{
	public class Lumberjacking : HarvestSystem
	{
		...
		private Lumberjacking()
		{
			...
			lumber.EffectCounts = (Core.AOS ? new int[]{ 1 } : new int[]{ 2, 2, 2, 3 });
			lumber.EffectDelay = TimeSpan.FromSeconds( 1.6 );
			lumber.EffectSoundDelay = TimeSpan.FromSeconds( 0.9 );

            lumber.NoResourcesMessage = "There's not enough wood here to harvest.";
            lumber.FailMessage = "You hack at the tree for a while, but fail to produce any useable wood.";
            lumber.OutOfRangeMessage = "That is too far away.";
            lumber.PackFullMessage = "You can't place any wood into your backpack!";
            lumber.ToolBrokeMessage = "You broke your axe.";
			...
			else
			{
				res = new HarvestResource[]
				{
					new HarvestResource( 00.0, 00.0, 100.0, "You chop some wood from the tree and put it in your backpack.", typeof( Log ) )
				};
                ...
                /*lumber.BonusResources = new BonusHarvestResource[]
				{
					new BonusHarvestResource( 0, 5.0, "You were able to knock some kindling off the tree and put it in your backpack.", typeof(Kindling) ),	//Nothing
				};*/
			}
