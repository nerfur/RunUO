...
namespace Server.Items
{
	...
	public class PrizedFish : BaseMagicFish
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "prized fish"));
            }
        }
	...
	public class WondrousFish : BaseMagicFish
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "wondrous fish"));
            }
        }
	...
	public class TrulyRareFish : BaseMagicFish
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "truly rare fish"));
            }
        }
	...
	public class PeculiarFish : BaseMagicFish
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "highly peculiar fish"));
            }
        }
