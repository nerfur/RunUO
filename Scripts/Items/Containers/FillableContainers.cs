...
namespace Server.Items
{
	...
	public class LibraryBookcase : FillableContainer
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bookcase"));
                if (this.Locked == false)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "(" + this.TotalItems + " items, " + this.TotalWeight + " stones)"));
                }
	...
	public class FillableContent
	{
		...
		public static FillableContent ArtisanGuild = new FillableContent(
			...
			new FillableEntry[]
			{
				...
				new FillableEntry( 1, typeof( Statue1 ) ),
				new FillableEntry( 1, typeof( Statue2 ) ),
				new FillableEntry( 1, typeof( Statue3 ) ),
				new FillableEntry( 1, typeof( Statue4 ) ),
				new FillableEntry( 1, typeof( Statue5 ) ),
