...
namespace Server.Items
{
	public class Lantern : BaseEquipableLight
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a lantern"));
            }
        }
	...
	public class LanternOfSouls : Lantern
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "lantern of souls"));
            }
        }
