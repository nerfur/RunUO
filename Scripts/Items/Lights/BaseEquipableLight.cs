	...
	public abstract class BaseEquipableLight : BaseLight
	{
		...
		/*public override void Ignite()
		{
			if ( !(Parent is Mobile) && RootParent is Mobile )
			{
				...
				{
					if ( this is Candle )
						holder.SendAsciiMessage( "You put the candle in your left hand." ); // You put the candle in your left hand.
					else if ( this is Torch )
						holder.SendAsciiMessage( "You put the torch in your left hand." ); // You put the torch in your left hand.

					base.Ignite();
				}
				else
				{
					holder.SendAsciiMessage( "You cannot hold this item." ); // You cannot hold this item.
				}
			}
			else
			{
