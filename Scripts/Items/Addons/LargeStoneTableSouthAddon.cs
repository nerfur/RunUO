...
namespace Server.Items
{
	public class LargeStoneTableSouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x1205, "a stone table"), 0, 0, 0);
            AddComponent(new AddonComponent(0x1206, "a stone table"), 1, 0, 0);
            AddComponent(new AddonComponent(0x1204, "a stone table"), 2, 0, 0);
			Hue = hue;
		}
