...
namespace Server.Items
{
	public class SmallStretchedHideEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x1069, "stretched hide"), 0, 0, 0);
		}
	...
	public class SmallStretchedHideSouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x107A, "stretched hide"), 0, 0, 0);
		}
	...
	public class MediumStretchedHideEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x106B, "stretched hide"), 0, 0, 0);
		}
	...
	public class MediumStretchedHideSouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x107C, "stretched hide"), 0, 0, 0);
		}
