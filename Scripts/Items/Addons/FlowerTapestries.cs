...
namespace Server.Items
{
	public class LightFlowerTapestryEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xFDC, "a tapestry"), 0, 0, 0);
            AddComponent(new AddonComponent(0xFDB, "a tapestry"), 0, 1, 0);
		}
	...
	public class LightFlowerTapestrySouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xFD9, "a tapestry"), 0, 0, 0);
            AddComponent(new AddonComponent(0xFDA, "a tapestry"), 1, 0, 0);
		}
	...
	public class DarkFlowerTapestryEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xFE0, "a tapestry"), 0, 0, 0);
            AddComponent(new AddonComponent(0xFDF, "a tapestry"), 0, 1, 0);
		}
	...
	public class DarkFlowerTapestrySouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xFDD, "a tapestry"), 0, 0, 0);
            AddComponent(new AddonComponent(0xFDE, "a tapestry"), 1, 0, 0);
		}
