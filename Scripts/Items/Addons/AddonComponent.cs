...
namespace Server.Items
{
	...
	public class AnvilComponent : AddonComponent
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "an anvil"));
            }
        }
	...
	public class ForgeComponent : AddonComponent
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a forge"));
            }
        }
	...
	public class AddonComponent : Item, IChopable
	{
        ...
        [Constructable]
        public AddonComponent(int itemID, string m_Name) : base(itemID)
        {
            Name = m_Name;
            Movable = false;
            ApplyLightTo(this);
