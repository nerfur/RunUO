...
namespace Server.Items
{
	public class LargeBedSouthAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xA83, "a bed"), 0, 0, 0);
            AddComponent(new AddonComponent(0xA7F, "a bed"), 0, 1, 0);
            AddComponent(new AddonComponent(0xA82, "a bed"), 1, 0, 0);
            AddComponent(new AddonComponent(0xA7E, "a bed"), 1, 1, 0);
		}
