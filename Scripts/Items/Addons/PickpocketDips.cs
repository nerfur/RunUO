...
namespace Server.Items
{
	...
	public class PickpocketDip : AddonComponent
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( !from.InRange( GetWorldLocation(), 1 ) )
                ...
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Regular, 0, 3, "", "Your ability to steal cannot improve any further by simply practicing on a dummy."));
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a pickpocket dip"));
            }
        }
	...
	public class PickpocketDipSouthAddon : BaseAddon
	{
		...
		{
			AddComponent( new PickpocketDip( 0x1E2C ), 0, 0, 0 );
		}
