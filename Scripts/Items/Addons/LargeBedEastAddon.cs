...
namespace Server.Items
{
	public class LargeBedEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0xA7D, "a bed"), 0, 0, 0);
            AddComponent(new AddonComponent(0xA7C, "a bed"), 0, 1, 0);
            AddComponent(new AddonComponent(0xA79, "a bed"), 1, 0, 0);
            AddComponent(new AddonComponent(0xA78, "a bed"), 1, 1, 0);
		}
