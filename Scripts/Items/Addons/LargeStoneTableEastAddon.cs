...
namespace Server.Items
{
	public class LargeStoneTableEastAddon : BaseAddon
	{
		...
		{
            AddComponent(new AddonComponent(0x1202, "a stone table"), 0, 0, 0);
            AddComponent(new AddonComponent(0x1203, "a stone table"), 0, 1, 0);
            AddComponent(new AddonComponent(0x1201, "a stone table"), 0, 2, 0);
			Hue = hue;
		}
