...
namespace Server.Items
{
	public class FlourMillSouthAddon : BaseAddon, IFlourMill
	{
		...
		{
            AddComponent(new AddonComponent(0x192C, "a flour mill"), 0, -1, 0);
            AddComponent(new AddonComponent(0x192E, "a flour mill"), 0, 0, 0);
            AddComponent(new AddonComponent(0x1930, "a flour mill"), 0, 1, 0);
		}
