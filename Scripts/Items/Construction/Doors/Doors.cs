...
namespace Server.Items
{
	...
	public class IronGateShort : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "an iron gate"));
            }
        }
	...
	public class LightWoodGate : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a wooden gate"));
            }
        }
	...
	public class MetalDoor : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a metal door"));
            }
        }
	...
	public class BarredMetalDoor : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a barred metal door"));
            }
        }
	...
	public class RattanDoor : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a rattan door"));
            }
        }
	...
	public class DarkWoodDoor : BaseDoor
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a wooden door"));
            }
        }
