...
namespace Server.Items
{
	public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability
	{
        ...
        public string GetDurabilityLevel()
        {
            ...
            switch (m_Durability)
            {
                case ArmorDurabilityLevel.Durable: name = "durable"; break;
                case ArmorDurabilityLevel.Substantial: name = "substantial"; break;
                case ArmorDurabilityLevel.Massive: name = "massive"; break;
                case ArmorDurabilityLevel.Fortified: name = "fortified"; break;
                case ArmorDurabilityLevel.Indestructible: name = "indestructible"; break;
            }
        ...
        public string GetProtectionLevel()
        {
            ...
            switch (m_Protection)
            {
                case ArmorProtectionLevel.Defense: name = "of defense"; break;
                case ArmorProtectionLevel.Guarding: name = "of guarding"; break;
                case ArmorProtectionLevel.Hardening: name = "of hardening"; break;
                case ArmorProtectionLevel.Fortification: name = "of fortification"; break;
                case ArmorProtectionLevel.Invulnerability: name = "of invulnerability"; break;
            }
				...
				if ( item is BaseArmor )
				{
					...
					else if ( !armor.AllowMaleWearer && !m.Female && m.AccessLevel < AccessLevel.GameMaster )
					{
						if ( armor.AllowFemaleWearer )
							m.SendAsciiMessage( "Only females can wear this." ); // Only females can wear this.
						else
			...
			if( from.AccessLevel < AccessLevel.GameMaster )
			{
				...
				else if( !AllowMaleWearer && !from.Female )
				{
					if( AllowFemaleWearer )
						from.SendAsciiMessage( "Only females can wear this." ); // Only females can wear this.
					else
				...
				else
				{
					...
					{
						from.SendAsciiMessage( "You do not have enough dexterity to equip this item." ); // You do not have enough dexterity to equip this item.
						return false;
					}
		...
		public virtual int OnHit( BaseWeapon weapon, int damageTaken )
		{
            ...
            double HalfAr = /*ArmorRating * scalar*/ArmorRatingScaled / 2.0;
					...
					if ( wear > 0 && m_MaxHitPoints > 0 )
					{
						...
						if ( wear > 0 )
						{
							if ( m_MaxHitPoints > wear )
							{
								...
								if ( Parent is Mobile )
									((Mobile)Parent).LocalOverheadMessage( MessageType.Regular, 0x3B2, true, "Your equipment is severely damaged." ); // Your equipment is severely damaged.
							}
							else
							{
								Delete();
