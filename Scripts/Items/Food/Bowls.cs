...
namespace Server.Items
{
	...
	public class EmptyPewterBowl : Item
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a pewter bowl"));
            }
        }
	...
	public class WoodenBowlOfCarrots : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of carrots"));
            }
        }
	...
	public class WoodenBowlOfCorn : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of corn"));
            }
        }
	...
	public class WoodenBowlOfLettuce : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of lettuce"));
            }
        }
	...
	public class WoodenBowlOfPeas : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of peas"));
            }
        }
	...
	public class PewterBowlOfPotatos : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of potatos"));
            }
        }
	...
	public class EmptyWoodenTub : Item
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a large wooden bowl"));
            }
        }
	...
	public class EmptyPewterTub : Item
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a large pewter bowl"));
            }
        }
	...
	public class WoodenBowlOfStew : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of stew"));
            }
        }
	...
	public class WoodenBowlOfTomatoSoup : Food
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a bowl of tomato soup"));
            }
        }
