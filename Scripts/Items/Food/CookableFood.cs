...
//#if false
		public override void OnDoubleClick( Mobile from )
		{
            ...
            from.SendAsciiMessage("What should I cook this on?");
...
//#endif
	...
	public class RawRibs : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " raw ribs"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "raw ribs"));
                }
            }
        }
	...
	public class RawLambLeg : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " raw lamb legs"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a raw lamb leg"));
                }
            }
        }
	...
	public class RawChickenLeg : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " raw chicken legs"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a raw chicken leg"));
                }
            }
        }
	...
	public class RawBird : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " raw birds"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a raw bird"));
                }
            }
        }
	...
	public class UnbakedPeachCobbler : CookableFood
	{
        ...
        public override void OnSingleClick( Mobile from ) 
		{
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked peach cobbler"));
            }
		}
	...
	public class UnbakedFruitPie : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked fruit pie"));
            }
        }
	...
	public class UnbakedMeatPie : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked meat pie"));
            }
        }
	...
	public class UnbakedPumpkinPie : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked pumpkin pie"));
            }
        }
	...
	public class UnbakedApplePie : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked apple pie"));
            }
        }
	...
	public class UncookedCheesePizza : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked cheese pizza"));
            }
        }
	...
	public class UncookedSausagePizza : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked sausage pizza"));
            }
        }
	...
	public class UnbakedQuiche : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "unbaked quiche"));
            }
        }
	...
	public class Eggs : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " eggs"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "eggs"));
                }
            }
        }
	...
	public class BrightlyColoredEggs : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "brightly colored eggs"));
            }
        }
	...
	public class EasterEggs : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "easter eggs"));
            }
        }
	...
	public class CookieMix : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "cookie mix"));
            }
        }
	...
	public class CakeMix : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "cake mix"));
            }
        }
	...
	public class RawFishSteak : CookableFood
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (Amount >= 2)
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", Amount + " raw fish steaks"));
                }
                else
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "raw fish steak"));
                }
            }
        }
