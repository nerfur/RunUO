...
namespace Server.Items
{
	...
	public class RecallRune : Item
	{
		...
		public override void OnSingleClick( Mobile from )
		{
            ...
            else
            {
                if (m_Marked)
                {
                    ...
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", String.Format(RuneFormat, desc)));
                ...
                else
                {
                    ...
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "an unmarked recall rune"));
                }
            }
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
                from.SendAsciiMessage("You cannot edit the description for this rune.");
				number = 1062399; // You cannot edit the description for this rune.
			}
			else if ( m_Marked )
			{
                from.SendAsciiMessage("Please enter a description for this marked object.");
			...
			{
                from.SendAsciiMessage("That rune is not yet marked.");
		...
		private class RenamePrompt : Prompt
		{
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Rune.House == null && m_Rune.Marked )
				{
					...
					from.SendAsciiMessage( "The etching on the rune has been changed." ); // The etching on the rune has been changed.
				}
			}
		}
