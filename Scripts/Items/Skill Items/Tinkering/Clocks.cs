...
namespace Server.Items
{
	...
	public class Clock : Item
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a clock"));
            }
        }
		...
		{
			GetTime( null, null, null, 0, 0, out generalNumber, out exactTime );
		}

        public static void GetTime(Mobile from, out int generalNumber, out string exactTime)
        {
            GetTime(null, from, from.Map, from.X, from.Y, out generalNumber, out exactTime);
        }
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			GetTime( this, from, out genericNumber, out exactTime );
