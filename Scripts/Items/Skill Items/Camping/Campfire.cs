...
namespace Server.Items
{
	...
	public class Campfire : Item
	{
        ...
        private PlayerMobile m_Starter;
        ...
        public Campfire(Mobile from) : base( 0xDE3)
		{
			Movable = false;
            ...
            m_Starter = from as PlayerMobile;
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a campfire"));
            }
        }
