...
namespace Server.Items
{
	...
	public abstract class BaseInstrument : Item, ICraftable, ISlayer
	{
		...
		public void ConsumeUse( Mobile from )
		{
			...
			{
				if ( from != null )
					from.SendAsciiMessage( "The instrument played its last tune." ); // The instrument played its last tune.
		...
		public static void PickInstrument( Mobile from, InstrumentPickedCallback callback )
		{
			...
			{
				from.SendAsciiMessage( "What instrument shall you play?" ); // What instrument shall you play?
		...
		public static void OnPickedInstrument( Mobile from, object targeted, object state )
		{
			...
			if ( instrument == null )
			{
				from.SendAsciiMessage( "That is not a musical instrument." ); // That is not a musical instrument.
			}
			else
			{
