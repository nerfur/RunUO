...
namespace Server.Items
{
	...
	public class Scissors : Item
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "scissors"));
            }
        }
		...
		{
            from.SendAsciiMessage("What should I use these scissors on?");
		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				{
					from.SendAsciiMessage( "Didn't your parents ever tell you not to run with scissors in your hand?!" ); // Didn't your parents ever tell you not to run with scissors in your hand?!
				}
