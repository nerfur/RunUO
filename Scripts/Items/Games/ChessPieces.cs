...
namespace Server.Items
{
	public class PieceWhiteKing : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white king"));
            }
        }
	...
	public class PieceBlackKing : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black king"));
            }
        }
	...
	public class PieceWhiteQueen : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white queen"));
            }
        }
	...
	public class PieceBlackQueen : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black queen"));
            }
        }
	...
	public class PieceWhiteRook : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white rook"));
            }
        }
	...
	public class PieceBlackRook : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black rook"));
            }
        }
	...
	public class PieceWhiteBishop : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white bishop"));
            }
        }
	...
	public class PieceBlackBishop : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black bishop"));
            }
        }
	...
	public class PieceWhiteKnight : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white knight"));
            }
        }
	...
	public class PieceBlackKnight : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black knight"));
            }
        }
	...
	public class PieceWhitePawn : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "white pawn"));
            }
        }
	...
	public class PieceBlackPawn : BasePiece
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "black pawn"));
            }
        }
