	...
	public class KeyRing : Item
	{
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			...
			if ( key == null || key.KeyValue == 0 )
			{
                ...
                from.SendAsciiMessage("Only non-blank keys can be put on a keyring.");
				return false;
			}
			else if ( this.Keys.Count >= MaxKeys )
			{
				//from.SendLocalizedMessage( 1008138 ); // This keyring is full.
                from.SendAsciiMessage("This keyring is full.");
				return false;
			}
			else
			{
                ...
                //from.SendAsciiMessage("You put the key on the keyring.");
				return true;
			}
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
            ...
            from.SendAsciiMessage("What do you want to unlock?");
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
                from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a key ring"));
            }
        }
