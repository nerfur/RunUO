// RunUO v2.0 distro script 
// modified to provide old style osi behaviour
// sub version 1.0 6/18/06 by David
...
namespace Server.Items
{
    public class PublicMoongate : Item
    {
        ...
        {
            /*if (Map == Map.Felucca || Map == Map.Trammel || !from.Player)
            {
    ...
    public class PMList
    {
        ...
        // **** Order only changed to support old style Moongates **** //
            ...
            new PMList(1012000, 1012012, Map.Trammel, new PMEntry[]
                {
                    ...
                    //new PMEntry( new Point3D( 3763, 2771, 50), 1046259 )  // Haven // remove to be osi correct
                });
