...
namespace Server.Network
{
    ...
    public sealed class CorpseEquipContent : Packet
    {
        public CorpseEquipContent(Mobile beholder, Corpse beheld)
            : base(0x3C)
        {
    ...
    public sealed class CorpseEquipContent6017 : Packet
    {
        public CorpseEquipContent6017(Mobile beholder, Corpse beheld)
            : base(0x3C)
        {
            List<Item> items = beheld.EquipItems;
            int count = items.Count;
