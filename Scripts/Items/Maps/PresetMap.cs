	...
	public class PresetMap : MapItem
	{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            else
            {
                if (name == "Britain")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Britain"));
                }
                else if (name == "BritaintoSkaraBrae")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Britain to Skara Brae"));
                }
                else if (name == "BritainToTrinsic")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Britain to Trinsic"));
                }
                else if (name == "BucsDen")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Buccaneer's Den"));
                }
                else if (name == "BucsDenToMagincia")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Buccaneer's Den to Magincia"));
                }
                else if (name == "BucsDenToOcllo")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Buccaneer's Den to Ocllo"));
                }
                else if (name == "Jhelom")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Jhelom"));
                }
                else if (name == "Magincia")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Magincia"));
                }
                else if (name == "MaginciaToOcllo")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Magincia to Ocllo"));
                }
                else if (name == "Minoc")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Minoc"));
                }
                else if (name == "MinocToYew")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Minoc to Yew"));
                }
                else if (name == "MinocToVesper")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Minoc to Vesper"));
                }
                else if (name == "Moonglow")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Moonglow"));
                }
                else if (name == "MoonglowToNujelm")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Moonglow to Nujelm"));
                }
                else if (name == "Nujelm")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Nujelm"));
                }
                else if (name == "NujelmToMagincia")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Nujelm to Magincia"));
                }
                else if (name == "Ocllo")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Ocllo"));
                }
                else if (name == "SerpentsHold")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Serpents Hold"));
                }
                else if (name == "SerpentsHoldToOcllo")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Serpents Hold to Ocllo"));
                }
                else if (name == "SkaraBrae")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Skara Brae"));
                }
                else if (name == "TheWorld")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of the World"));
                }
                else if (name == "Trinsic")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Trinsic"));
                }
                else if (name == "TrinsicToBucsDen")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Trinsic to Buccaneer's Den"));
                }
                else if (name == "TrinsicToJhelom")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Trinsic to Jhelom"));
                }
                else if (name == "Vesper")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Vesper"));
                }
                else if (name == "VesperToNujelm")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Vesper to Nujelm"));
                }
                else if (name == "Yew")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Yew"));
                }
                else if (name == "YewToBritain")
                {
                    from.Send(new AsciiMessage(Serial, ItemID, MessageType.Label, 0, 3, "", "a map of Yew to Britain"));
                }
            }
