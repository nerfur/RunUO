...
namespace Server.Mobiles
{
	public class Armorer : BaseVendor
	{
		...
		{
			get{ return new Server.Items.Boots(Utility.RandomNeutralHue()); }
		}
		...
		public override void InitOutfit()
		{
			...
			AddItem( new Server.Items.HalfApron( Utility.BrownHue() ) );
            AddItem(new Server.Items.Bascinet() { Hue = Utility.RandomMetalHue() });
