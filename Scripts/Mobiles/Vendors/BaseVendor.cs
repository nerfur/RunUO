...
namespace Server.Mobiles
{
	...
	public abstract class BaseVendor : BaseCreature, IVendor
	{
        ...
        private const int MaxSellAmount = 100;

        private const int MaxWallet = 1000;
        private TimeSpan WalletDelay = TimeSpan.FromHours(3.0);
        ...
        private DateTime m_LastWallet;
        public DateTime LastWallet
        {
            get { return m_LastWallet; }
            set { m_LastWallet = value; }
        }
        ...
        public override bool AlwaysMurderer { get { return IsInBucs; } }
        ...
        public virtual bool IsInBucs
        {
            get
            {

                int x = Home.X, y = Home.Y;

                return (x >= 2574 && y >= 1919 && x < 2876 && y < 2359);
            }
        }
		...
		public virtual Item ShoeType
		{
            get { return RandomShoes(Utility.RandomNeutralHue()); }
		}
		...
		private static TimeSpan InventoryDecayTime = TimeSpan.FromMinutes( (double)(Utility.RandomMinMax( 40, 60)));
		...
		public virtual void VendorBuy( Mobile from )
		{
			...
			{
				Say( true, "I shall not treat with scum like thee!" ); // I shall not treat with scum like thee!
				return;
			}
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write((int)m_Wallet);
            writer.Write((DateTime)m_LastWallet);
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 2:
                    {
                        m_Wallet = reader.ReadInt();
                        if (m_Wallet > MaxWallet)
                            m_Wallet = MaxWallet;

                        m_LastWallet = reader.ReadDateTime();
                        goto case 1;
                    }
				case 1:
				{
