...
{ 
	...
	{ 
		...
		{ 
			...
			{ 
				Add( new GenericBuyInfo( typeof( RawFishSteak ), 3, 9, 0x97A, 0 ) );
				//TODO: Add( new GenericBuyInfo( typeof( SmallFish ), 3, 9, 0xDD6, 0 ) );
				//TODO: Add( new GenericBuyInfo( typeof( SmallFish ), 3, 9, 0xDD7, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( FishingPole ), 15, 9, 0xDC0, 0 ) );
			} 
		} 
