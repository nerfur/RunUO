	...
	public class SBScribe: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				//Add( new GenericBuyInfo( typeof( ScribesPen ), 8, 9, 0xFC0, 0 ) );
				Add( new GenericBuyInfo( typeof( BrownBook ), 15, 9, 0xFEF, 0 ) );
				Add( new GenericBuyInfo( typeof( TanBook ), 15, 9, 0xFF0, 0 ) );
				Add( new GenericBuyInfo( typeof( BlueBook ), 15, 9, 0xFF2, 0 ) );
				//Add( new GenericBuyInfo( "1041267", typeof( Runebook ), 3500, 9, 0xEFA, 0x461 ) );
			}
		}
