	...
	public class SBCarpenter: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( SmoothingPlane ), 10, 9, 0x1032, 0 ) );
				Add( new GenericBuyInfo( typeof( JointingPlane ), 11, 9, 0x1030, 0 ) );
				Add( new GenericBuyInfo( typeof( Drums ), 21, 9, 0xE9C, 0 ) );
				Add( new GenericBuyInfo( typeof( Tambourine ), 21, 9, 0xE9D, 0 ) );
				Add( new GenericBuyInfo( typeof( LapHarp ), 21, 9, 0xEB2, 0 ) );
				Add( new GenericBuyInfo( typeof( Lute ), 21, 9, 0xEB3, 0 ) );
			}
		}
