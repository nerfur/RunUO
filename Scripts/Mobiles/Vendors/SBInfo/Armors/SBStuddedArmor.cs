...
namespace Server.Mobiles
{
	public class SBStuddedArmor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				Add( new GenericBuyInfo( typeof( StuddedArms ), 87, 9, 0x13DC, 0 ) );
				Add( new GenericBuyInfo( typeof( StuddedChest ), 128, 9, 0x13DB, 0 ) );
				Add( new GenericBuyInfo( typeof( StuddedGloves ), 79, 9, 0x13D5, 0 ) );
				Add( new GenericBuyInfo( typeof( StuddedGorget ), 73, 9, 0x13D6, 0 ) );
				Add( new GenericBuyInfo( typeof( StuddedLegs ), 103, 9, 0x13DA, 0 ) );
				Add( new GenericBuyInfo( typeof( FemaleStuddedChest ), 142, 9, 0x1C02, 0 ) );
				Add( new GenericBuyInfo( typeof( StuddedBustierArms ), 120, 9, 0x1c0c, 0 ) );
			}
		}
