...
{ 
	...
	{ 
		...
		{ 
			...
			{ 
				Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, 9, 0x103B, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( RoastPig ), 106, 9, 0x9BB, 0 ) );
				Add( new GenericBuyInfo( typeof( SackFlour ), 3, 9, 0x1039, 0 ) );
				Add( new GenericBuyInfo( typeof( JarHoney ), 3, 9, 0x9EC, 0 ) );
				//Add( new GenericBuyInfo( typeof( RollingPin ), 2, 9, 0x1043, 0 ) );
				//Add( new GenericBuyInfo( typeof( FlourSifter ), 2, 9, 0x103E, 0 ) );
				//Add( new GenericBuyInfo( "1044567", typeof( Skillet ), 3, 9, 0x97F, 0 ) );
