	...
	public class Sheep : BaseCreature, ICarvable
	{
		...
		public void Carve( Mobile from, Item item )
		{
			if ( DateTime.Now < m_NextWoolTime )
			{
                ...
                //SayTo(from, true, "This sheep is not yet ready to be shorn.");
                PrivateOverheadMessage(MessageType.Regular, 0x3B2, true, "This sheep is not yet ready to be shorn.",from.NetState);
				return;
			}

			from.SendAsciiMessage( "You place the gathered wool into your backpack." ); // You place the gathered wool into your backpack.
