...
namespace Server.Gumps
{
	...
	{
		public static readonly PolymorphEntry Chicken =		new PolymorphEntry( 8401, 0xD0, 1015236, "Chicken", 15, 10 );
		public static readonly PolymorphEntry Dog =			new PolymorphEntry( 8405, 0xD9, 1015237, "Dog",17, 10 );
		public static readonly PolymorphEntry Wolf =		new PolymorphEntry( 8426, 0xE1, 1015238, "Wolf",18, 10 );
		public static readonly PolymorphEntry Panther =		new PolymorphEntry( 8473, 0xD6, 1015239, "Panther",20, 14 );
		public static readonly PolymorphEntry Gorilla =		new PolymorphEntry( 8437, 0x1D, 1015240, "Gorilla",23, 10 );
		public static readonly PolymorphEntry BlackBear =	new PolymorphEntry( 8399, 0xD3, 1015241, "Bear, Black",22, 10 );
		public static readonly PolymorphEntry GrizzlyBear =	new PolymorphEntry( 8411, 0xD4, 1015242, "Bear, Grizzly", 22, 12 );
		public static readonly PolymorphEntry PolarBear =	new PolymorphEntry( 8417, 0xD5, 1015243, "Bear, Polar",26, 10 );
		public static readonly PolymorphEntry HumanMale =	new PolymorphEntry( 8397, 0x190, 1015244, "Human, Male",29, 8 );
		public static readonly PolymorphEntry HumanFemale =	new PolymorphEntry( 8398, 0x191, 1015254, "Human, Female",29, 10 );
		public static readonly PolymorphEntry Slime =		new PolymorphEntry( 8424, 0x33, 1015246, "Slime",5, 10 );
		public static readonly PolymorphEntry Orc =			new PolymorphEntry( 8416, 0x11, 1015247, "Orc",29, 10 );
		public static readonly PolymorphEntry LizardMan =	new PolymorphEntry( 8414, 0x21, 1015248, "Lizardman",26, 10 );
		public static readonly PolymorphEntry Gargoyle =	new PolymorphEntry( 8409, 0x04, 1015249, "Gargoyle",22, 10 );
		public static readonly PolymorphEntry Ogre =		new PolymorphEntry( 8415, 0x01, 1015250, "Ogre",24, 9 );
		public static readonly PolymorphEntry Troll =		new PolymorphEntry( 8425, 0x36, 1015251, "Troll",25, 9 );
		public static readonly PolymorphEntry Ettin =		new PolymorphEntry( 8408, 0x02, 1015252, "Ettin",25, 8 );
		public static readonly PolymorphEntry Daemon =		new PolymorphEntry( 8403, 0x09, 1015253, "Daemon",25, 8 );


		private int m_Art, m_Body, m_Num, m_X, m_Y;
        private string m_Name;

		private PolymorphEntry( int Art, int Body, int LocNum, string StringName, int X, int Y )
		{
            m_Name = StringName;
			m_Art = Art;
			m_Body = Body;
        ...
        public string StringName { get { return m_Name; } }
