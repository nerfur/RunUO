		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case 7:
				{
					...
					if( !m_IsResigning )
					{
						pm.SendAsciiMessage( "Are you sure you wish to resign from your guild?" ); // Are you sure you wish to resign from your guild?
						pm.SendGump( new GuildInfoGump( pm, guild, true ) );
					}
					else
					{
						guild.RemoveMember( pm, "You resign from your guild." ); // You resign from your guild.
					}
					break;
				}
			}
