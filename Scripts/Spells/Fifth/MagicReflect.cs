...
namespace Server.Spells.Fifth
{
	public class MagicReflectSpell : MagerySpell
	{
		...
		public override bool CheckCast()
		{
			...
			{
			    Caster.SendAsciiMessage( "The spell will not adhere to you at this time." ); // The spell will not adhere to you at this time.
			...
			else
			{
				...
				else if ( CheckSequence() )
				{
					...
					//{
                        ...
                        value = 100;//value = (int)(8 + (value/100)*7.0);//absorb from 8 to 15 "circles"
