...
namespace Server.Spells.Fifth
{
	public class BladeSpiritsSpell : MagerySpell
	{
		...
		public override TimeSpan GetCastDelay()
		{
            ...
            return TimeSpan.FromSeconds(base.GetCastDelay().TotalSeconds * 5); /* + TimeSpan.FromSeconds( 6.0 )*/
		}
		...
		private class InternalTarget : Target
		{
			...
			{
				from.SendAsciiMessage( "Target cannot be seen. Try again." ); // Target cannot be seen. Try again.
