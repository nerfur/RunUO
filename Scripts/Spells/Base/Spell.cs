...
namespace Server.Spells
{
	public abstract class Spell : ISpell
	{
        ...
        private static TimeSpan NextSpellDelay = TimeSpan.Zero;//.FromSeconds( 0.75 );
		...
		public virtual bool OnCasterMoving( Direction d )
		{
			...
			{
				m_Caster.SendAsciiMessage( "You are frozen and can not move." ); // You are frozen and can not move.
				return false;
			}
		...
		public virtual int GetDamageFixed( Mobile m )
		{
            ...
            return 0;//m.Skills[DamageSkill].Fixed;
		}
		...
		public virtual double GetDamageSkill( Mobile m )
		{
            ...
            return 0;//m.Skills[DamageSkill].Value;
		}
		...
		{
			m_Caster.LocalOverheadMessage( MessageType.Regular, 0x3B2, true, "The spell fizzles." ); // The spell fizzles.
        ...
        public virtual bool CheckNextSpellTime { get { return !(m_Scroll is BaseWand || m_Scroll is GnarledStaff || m_Scroll is BaseJewel || m_Scroll is BaseStationary); } }
		...
		public bool CheckBSequence( Mobile target, bool allowDead )
		{
			...
			{
				m_Caster.SendAsciiMessage( "This spell won't work on that!" ); // This spell won't work on that!
				return false;
			}
