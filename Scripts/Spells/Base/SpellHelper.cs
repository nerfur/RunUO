...
namespace Server.Spells
{
	...
	public class SpellHelper
	{
		...
		public static bool ValidIndirectTarget( Mobile from, Mobile to )
		{
			...
			return /*noto != Notoriety.Innocent || from.Kills >= 5*/ true;
		}
		...
		private static TravelValidator[] m_Validators = new TravelValidator[]
			{
                new TravelValidator( IsLvlOneDungeon ),
                new TravelValidator( IsLvlTwoDungeon ),
		...
		private static bool[,] m_Rules = new bool[,]
			{
						/*Lvl1  Lvl2      T2A(Fel)		Ilshenar		Wind(Tram),	Wind(Fel),	Dungeons(Fel),	Solen(Tram),	Solen(Fel), CrystalCave(Malas),	Gauntlet(Malas),	Gauntlet(Ferry),	Stronghold,		ChampionSpawn, Dungeons(Tokuno[Malas]) */
/* Recall From */		{ true, true,     false,		true,			true,			false,		false,			true,			false,		false,				false,				false,				true,			true,			true	 },
/* Recall To */			{ true, true,     false,		false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false	 },
/* Gate From */			{ true, false,    false,		false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false	 },
/* Gate To */			{ true, false,    false,		false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false	 },
/* Mark In */			{ true, true,     false,		false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false	 },
...
/* Tele To */			{ true, true,    true,			true,			true,			true,		true,			true,			true,		false,				true,				false,				false, 			true,			true	 },
		...
		public static void SendInvalidMessage( Mobile caster, TravelCheckType type )
		{
			if( type == TravelCheckType.RecallTo || type == TravelCheckType.GateTo )
				caster.SendAsciiMessage( "You are not allowed to travel there." ); // You are not allowed to travel there.
			else if( type == TravelCheckType.TeleportTo )
				caster.SendAsciiMessage( "You cannot teleport from here to the destination." ); // You cannot teleport from here to the destination.
			else
				caster.SendAsciiMessage( "Thy spell doth not appear to work..." ); // Thy spell doth not appear to work...
		}
        ...
        public static bool IsLvlOneDungeon(Map map, Point3D loc)
        {
            int x = loc.X, y = loc.Y;

            bool l1 = (x >= 5738 && y >= 1 && x <= 5860 && y <= 130);
            bool l2 = (x >= 5132 && y >= 523 && x <= 5235 && y <= 642);
            bool l3 = (x >= 5774 && y >= 512 && x <= 5774 + 111 && y <= 512 + 124);
            bool l4 = (x >= 5380 && y >= 516 && x <= 5380 + 137 && y <= 516 + 120);
            bool l5 = (x >= 5121 && y >= 891 && x <= 5121 + 249 && y <= 891 + 64);
            bool l6 = (x >= 5199 && y >= 955 && x <= 5199 + 171 && y <= 955 + 55);
            bool l7 = (x >= 5155 && y >= 955 && x <= 5155 + 44 && y <= 955 + 27);
            bool l8 = (x >= 5188 && y >= 768 && x <= 5188 + 145 && y <= 768 + 123);
            bool l9 = (x >= 5374 && y >= 1848 && x <= 5374 + 142 && y <= 1848 + 92);
            bool l10 = (x >= 5374 && y >= 1940 && x <= 5374 + 44 && y <= 1940 + 21);
            bool l11 = (x >= 5901 && y >= 14 && x <= 5901 + 103 && y <= 14 + 103);
            bool l12 = (x >= 5566 && y >= 623 && x <= 5566 + 24 && y <= 623 + 19);

            return (l1 || l2 || l3 || l4 || l5 || l6 || l7 || l8 || l9 || l10 || l11 ||l12);
        }

        public static bool IsLvlTwoDungeon(Map map, Point3D loc)
        {
            int x = loc.X, y = loc.Y;

            bool l1 = (x >= 5507 && y >= 3 && x <= 5507 + 128 && y <= 3 + 123);
            bool l2 = (x >= 5908 && y >= 140 && x <= 5908 + 96 && y <= 140 + 105);
            bool l3 = (x >= 5277 && y >= 523 && x <= 5277 + 78 && y <= 523 + 113);
            bool l4 = (x >= 5636 && y >= 513 && x <= 5636 + 113 && y <= 513 + 80);
            bool l5 = (x >= 5374 && y >= 645 && x <= 5374 + 159 && y <= 645 + 123);
            bool l6 = (x >= 5122 && y >= 789 && x <= 5122 + 63 && y <= 789 + 95);
            bool l7 = (x >= 5407 && y >= 1949 && x <= 5407 + 214 && y <= 1949 + 93);
            bool l8 = (x >= 5378 && y >= 1983 && x <= 5378 + 29 && y <= 1983 + 59);
		...
		public static bool IsFeluccaDungeon( Map map, Point3D loc )
		{
            ...
            if (IsLvlOneDungeon(map, loc) || IsLvlTwoDungeon(map, loc))
                return false;
            else
		...
		public static bool CheckTown( Point3D loc, Mobile caster )
		{
			...
			{
				caster.SendAsciiMessage( "You cannot cast this in town!" ); // You cannot cast this in town!
				return false;
			}
		...
		public static void Damage( Spell spell, TimeSpan delay, Mobile target, Mobile from, double damage )
		{
            ...
            if (noto == Notoriety.Enemy)
                canattack = true;
            else if (from != null && ((from.FindItemOnLayer(Layer.TwoHanded) is OrderShield) && (target.FindItemOnLayer(Layer.TwoHanded) is ChaosShield)) && target is PlayerMobile)
                canattack = true;
            else if (from != null && ((from.FindItemOnLayer(Layer.TwoHanded) is ChaosShield) && (target.FindItemOnLayer(Layer.TwoHanded) is OrderShield)) && target is PlayerMobile)
                canattack = true;
	...
	public class TransformationSpellHelper
	{
		...
		public static bool CheckCast( Mobile caster, Spell spell )
		{
			...
			{
				caster.SendAsciiMessage( "You can't do that while polymorphed." ); // You can't do that while polymorphed.
				return false;
			}
			else if( AnimalForm.UnderTransformation( caster ) )
			{
				caster.SendAsciiMessage( "You cannot cast that spell in this form." ); // You cannot cast that spell in this form.
				return false;
			}
