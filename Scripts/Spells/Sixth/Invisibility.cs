...
namespace Server.Spells.Sixth
{
	public class InvisibilitySpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			{
				Caster.SendAsciiMessage( "This spell won't work on that!" ); // This spell won't work on that!
			}
			else if ( CheckBSequence( m ) )
			{
                ...
                TimeSpan duration = TimeSpan.FromSeconds((6 * Caster.Skills.Magery.Fixed) / 5);
