...
namespace Server.Spells.Eighth
{
	public class AirElementalSpell : MagerySpell
	{
        ...
        {
            return TimeSpan.FromSeconds(base.GetCastDelay().TotalSeconds * 5);
        }
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendAsciiMessage( "You have too many followers to summon that creature." ); // You have too many followers to summon that creature.
				return false;
			}
