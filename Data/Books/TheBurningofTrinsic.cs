//////////////////////////////////////////////
//
// The Burning of            Trinsic by Paladin Japheth
//
...
{
	public class TheBurningofTrinsic : BaseBook
	{
		public static readonly BookContent Content = new BookContent
			(
				"The Burning of            Trinsic", "Paladin Japheth", 
				new BookPageInfo
				(
					"    'Twas a sight to ",
					"see, the sunlight ",
		...
		[Constructable]
		public TheBurningofTrinsic() : base( Utility.Random( 0xFEF, 2 ), false )
		{
		}

		public TheBurningofTrinsic( Serial serial ) : base( serial )
		{
		}
